...
public class RequestResourceBuilder {
	...
	public <S, T> void execute(AutoRestCallback<T> callback) {
	...
	public RequestResourceBuilder method(String method) {
		Objects.requireNonNull(method, "path required");
		this.method = method;
		return this;
	}

	public RequestResourceBuilder path(Object... paths) {
		for (Object path : paths)
			path(Objects.toString(Objects.requireNonNull(path, "path required")));
		return this;
	}

	public RequestResourceBuilder path(String path) {
		if (path.isEmpty())
	...
	public RequestResourceBuilder param(String key, Object value) {
		Objects.requireNonNull(key, "query param key required");
		handleLists(key, value, queryParams);
		return this;
	}

	public RequestResourceBuilder header(String key, Object value) {
		Objects.requireNonNull(key, "header param key required");
		handleLists(key, value, headerParams);
		return this;
	}

	public RequestResourceBuilder form(String key, Object value) {
	...
	public RequestResourceBuilder data(Object data) {
		this.data = data;
		return this;
	}
