package us.ascendtech.gwt.autorest.processor;
...
public class AutoRestGwtProcessorTest {
	@Test
	public void works() {
		JavaSourcesSubject.assertThat(JavaFileObjects.forSourceString("Rest",
				"" + "import com.intendia.gwt.autorest.client.AutoRestGwt;" + "import java.util.Optional;\n" + "import javax.ws.rs.GET;\n"
						+ "import javax.ws.rs.Path;\n" + "\n" + "@AutoRestGwt\n" + "@Path(\"a\") interface Rest {\n" + "    @GET Optional<String> getStr();\n"
						+ "}")).withCompilerOptions("-AskipJavaLangImports").processedWith(new AutoRestGwtProcessor()).compilesWithoutError().and()
				.generatesSources(JavaFileObjects.forSourceString("Rest_RestServiceModel",
						"" + "import static javax.ws.rs.HttpMethod.GET;\n" + "\n" + "import com.intendia.gwt.autorest.client.ResourceVisitor;\n"
								...
								+ "    @Override" + "    public Optional<String> getStr() {\n"
