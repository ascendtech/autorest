...
public class ResourceVisitorTest {
	...
	public void visitor_works() throws Exception {
		RequestResourceBuilder visitor = mock(RequestResourceBuilder.class, RETURNS_SELF);
	...
	public void gwt_incompatible_throws_exception() {
		TestService service = new TestService_RestServiceModel(mock(RequestResourceBuilder.class));
	...
	public interface TestService {
		...
		@GET
		@Path("b/{pS}/{pI}/c")
		List<String> method(@PathParam("pS") String pS, @PathParam("pI") int pI, @QueryParam("qS") String qS, @QueryParam("qI") int qI,
				@QueryParam("qIs") List<Integer> qIs, @HeaderParam("hS") String hS, @HeaderParam("hI") int hI);
